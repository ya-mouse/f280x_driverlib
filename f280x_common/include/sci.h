...
//#############################################################################
//
//! \file   f280x_common/include/sci.h
//!
...
typedef enum
{
    SCI_BaudRate_9_6_kBaud = 324,      //!< Denotes 9.6 kBaud
    SCI_BaudRate_19_2_kBaud = 161,     //!< Denotes 19.2 kBaud
    SCI_BaudRate_57_6_kBaud = 53,      //!< Denotes 57.6 kBaud
    SCI_BaudRate_115_2_kBaud = 27      //!< Denotes 115.2 kBaud
} SCI_BaudRate_e;
...
inline bool_t SCI_isRxDataReady(SCI_Handle sciHandle)
{
    ...
    status = (sci->SCIFFRX & SCI_SCIFFRX_FIFO_ST_BITS) >> 8;
