...
//#############################################################################
//
//! \file   f280x_common/include/pwm.h
//!
...
//!
#define PWM_AQCSFRC_CSFB_BITS           (3 << 0)
...
typedef enum
{
    PWM_ActionQual_CSF_Disabled=0,
    PWM_ActionQual_CSF_Low,
    PWM_ActionQual_CSF_Hgh
} PWM_ActionQual_CSF_e;
...
//! spru791f.pdf, page 18, table 1-1
//! spru924f.pdf, page 29, table 8
//!
...
//! \brief     Continuous Software Force for PWM A
//! \param[in] pwmHandle   The pulse width modulation (PWM) object handle
//! \param[in] csf         The CSF action qualifier
inline void PWM_setActionQual_SwForceA(PWM_Handle pwmHandle, const PWM_ActionQual_CSF_e csf)
{
    PWM_Obj *pwm = (PWM_Obj *)pwmHandle;
    ...
    return;
} // end of PWM_setActionQual_SwForceA() function


//! \brief     Continuous Software Force for PWM B
//! \param[in] pwmHandle   The pulse width modulation (PWM) object handle
//! \param[in] csf         The CSF action qualifier
inline void PWM_setActionQual_SwForceB(PWM_Handle pwmHandle, const PWM_ActionQual_CSF_e csf)
{
    PWM_Obj *pwm = (PWM_Obj *)pwmHandle;
