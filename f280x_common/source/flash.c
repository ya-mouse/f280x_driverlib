//#############################################################################
//
//! \file   f280x_common/source/flash.c
//!
...
#include "f280x_common/include/flash.h"
...
void FLASH_setup(FLASH_Handle flashHandle)
{
	...
	FLASH_setPowerMode(flashHandle, FLASH_PowerMode_PumpAndBankActive);

	FLASH_clear3VStatus(flashHandle);
...
//   FlashRegs.FACTIVEWAIT.bit.ACTIVEWAIT = 0x01FF;
    ...
    FLASH_setNumRandomReadWaitStates(flashHandle, FLASH_NumRandomWaitStates_3);
//   FlashRegs.FBANKWAIT.bit.RANDWAIT = 3;

    //Set the Paged Waitstate for the Flash
    FLASH_setNumPagedReadWaitStates(flashHandle, FLASH_NumPagedWaitStates_3);
//   FlashRegs.FBANKWAIT.bit.PAGEWAIT = 3;

    //Set the Waitstate for the OTP
    FLASH_setOtpWaitStates(flashHandle, FLASH_NumOtpWaitStates_5);
