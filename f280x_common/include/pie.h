...
//#############################################################################
//
//! \file   f280x_common/include/pie.h
//!
...
// **************************************************************************
// the includes
#include "f280x_common/include/cap.h"
...
typedef enum
{
    ...
    PIE_InterruptSource_ADCINT = (1 << 5),       //!< ADC Interrupt
    ...
    PIE_InterruptSource_ECAP4 = (1 << 3),          //!< ECAP 4 Interrupt
    ...
    PIE_InterruptSource_SPICRX = (1 << 4),         //!< SPI C RX Interrupt
    PIE_InterruptSource_SPICTX = (1 << 5),         //!< SPI C TX Interrupt
    PIE_InterruptSource_SPIDRX = (1 << 6),         //!< SPI D RX Interrupt
    PIE_InterruptSource_SPIDTX = (1 << 7),         //!< SPI D TX Interrupt
...
//! spru712h.pdf, page 123, table 6-4.
//!
typedef struct _PIE_Obj_
{
    ...
    volatile intVec_t      SEQ1INT;             //!< SEQ1INT interrupt vector
    volatile intVec_t      SEQ2INT;             //!< SEQ2INT interrupt vector
    ...
    volatile intVec_t      ADCINT;              //!< ADCINT interrupt vector
    ...
    volatile intVec_t      EPWM5_TZINT;         //!< EPWM5_TZINT interrupt vector
    volatile intVec_t      EPWM6_TZINT;         //!< EPWM6_TZINT interrupt vector
    ...
    volatile intVec_t      EPWM5_INT;           //!< EPWM5 interrupt vector
    volatile intVec_t      EPWM6_INT;           //!< EPWM6 interrupt vector
    ...
    volatile intVec_t      ECAP2_INT;           //!< ECAP2_INT interrupt vector
    volatile intVec_t      ECAP3_INT;           //!< ECAP3_INT interrupt vector
    volatile intVec_t      ECAP4_INT;           //!< ECAP4_INT interrupt vector
    ...
    volatile intVec_t      EQEP1_INT;           //!< EQEP1_INT interrupt vector
    volatile intVec_t      EQEP2_INT;           //!< EQEP2_INT interrupt vector
    ...
    volatile intVec_t      SPIRXINTB;           //!< SPIRXINTB interrupt vector
    volatile intVec_t      SPITXINTB;           //!< SPITXINTB interrupt vector
    volatile intVec_t      SPIRXINTC;           //!< SPIRXINTC interrupt vector
    volatile intVec_t      SPITXINTC;           //!< SPITXINTC interrupt vector
    volatile intVec_t      SPIRXINTD;           //!< SPIRXINTD interrupt vector
    volatile intVec_t      SPITXINTD;           //!< SPITXINTD interrupt vector
    ...
    volatile intVec_t      SCIRXINTB;           //!< SCIRXINTB interrupt vector
    volatile intVec_t      SCITXINTB;           //!< SCITXINTB interrupt vector
    volatile intVec_t      ECAN0INTA;           //!< ECAN0INTA interrupt vector
    volatile intVec_t      ECAN1INTA;           //!< ECAN1INTA interrupt vector
    volatile intVec_t      ECAN0INTB;           //!< ECAN0INTB interrupt vector
    volatile intVec_t      ECAN1INTB;           //!< ECAN1INTB interrupt vector
    volatile intVec_t      rsvd10_1;            //!< Reserved
    volatile intVec_t      rsvd10_2;            //!< Reserved
    volatile intVec_t      rsvd10_3;            //!< Reserved
    volatile intVec_t      rsvd10_4;            //!< Reserved
    volatile intVec_t      rsvd10_5;            //!< Reserved
    volatile intVec_t      rsvd10_6;            //!< Reserved
    volatile intVec_t      rsvd10_7;            //!< Reserved
    volatile intVec_t      rsvd10_8;            //!< Reserved
    ...
    volatile intVec_t      rsvd12_1;            //!< Reserved
...
//! \param[in] pieHandle  The peripheral interrupt expansion (PIE) object handle
//! \param[in] capNumber  The ECAPx number
void PIE_enableCaptureInt(PIE_Handle pieHandle, const CAP_Number_e capNumber);
