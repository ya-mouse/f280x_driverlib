...
//  (C) Copyright 2013, Anton D. Kachalov <mouse@ya.ru>
//#############################################################################
...
//! \brief Defines the location of the CONFIG bits in the GPQSEL register
//!
#define  GPIO_GPQSEL_CONFIG_BITS   (3 << 0)
...
typedef enum
{
  ...
  GPIO_1_Mode_SPISIMOD,            //!< Denotes a SPISIMOD function
  GPIO_1_Mode_Rsvd_3,              //!< Denotes a reserved function
  ...
  GPIO_3_Mode_SPISOMID,            //!< Denotes a SPISOMID function
  GPIO_3_Mode_Rsvd_3,              //!< Denotes a reserved function
  ...
  GPIO_5_Mode_SPICLKD,             //!< Denotes a SPICLKD function
  ...
  GPIO_7_Mode_SPISTED,             //!< Denotes a SPISTED function
  ...
  GPIO_8_Mode_CANTXB,              //!< Denotes a CANTXB function
  GPIO_8_Mode_ADCSOCAO_NOT,        //!< Denotes a ADCSOCAO_NOT function
  ...
  GPIO_13_Mode_CANRXB,             //!< Denotes a CANRXB function
  ...
  GPIO_15_Mode_TZ4_NOT,            //!< Denotes a TZ4_NOT function
  GPIO_15_Mode_SCIRXDB,            //!< Denotes a SCIRXDB function
  GPIO_15_Mode_SPISTEB,            //!< Denotes a SPISTEB function
  GPIO_16_Mode_GeneralPurpose=0,   //!< Denotes a general purpose function
  GPIO_16_Mode_SPISIMOA,           //!< Denotes a SPISIMOA function
  GPIO_16_Mode_CANTXB,             //!< Denotes a CANTXB function
  GPIO_16_Mode_TZ5_NOT,            //!< Denotes a TZ5_NOT function
  GPIO_17_Mode_GeneralPurpose=0,   //!< Denotes a general purpose function
  GPIO_17_Mode_SPISOMIA,           //!< Denotes a SPISOMIA function
  GPIO_17_Mode_CANRXB,             //!< Denotes a CANRXB function
  GPIO_17_Mode_TZ6_NOT,            //!< Denotes a TZ6_NOT function
  ...
  GPIO_23_Mode_SPISTEC,            //!< Denotes a SPISTEC function
...
typedef struct _GPIO_Obj_
{
    ...
    volatile uint16_t rsvd_3[32];      //!< Reserved
    ...
    volatile uint16_t rsvd_4[16];       //!< Reserved
    volatile uint16_t GPIOXINTnSEL[3]; //!< XINT1-3 Source Select Registers
    volatile uint16_t rsvd_5[5];       //!< Reserved
